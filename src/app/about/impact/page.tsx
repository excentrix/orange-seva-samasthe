...
const metricsData = [
  {
    ...
    description:
      "Distributed surplus food to over 25 million needy individuals.",
  ...
  },
  {
    ...
    suffix: "+", // Add "+" after the number
    description:
      "Implemented the Vidyanjali Project in 100+ government schools.",
  ...
  },
  {
    ...
    suffix: "+", // Add "+" after the number
    description:
      "Distributed food kits to 200k+ individuals during the pandemic.",
      ...
      <CardContent>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {metricsData.map((metric, index) => (
            <Card
              key={index}
              className="flex flex-col items-center p-4 shadow-lg transition-transform transform hover:shadow-xl"
            >
