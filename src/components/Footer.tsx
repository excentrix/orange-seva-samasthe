    ...
    <footer className="bg-gradient-to-r from-main to-blue-accent text-white py-12 mt-8">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center md:items-start">
        ...
        <div className="md:w-1/2 text-center">
          ...
          <div className="flex justify-center space-x-6" style={{marginLeft:'8rem'}}>
            <a
      ...
      <br />
      <div className="text-center mt-6" style={{marginLeft:'2rem'}}>
        <p className="text-sm">© 2024 Orange Seva Samsthe. All rights reserved.</p>
      </div>
    </footer>
  );
};
